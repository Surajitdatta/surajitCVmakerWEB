...
import Premiumcv from "./Premiumcv";
  ...
  return(
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
            ...
            <p class="blue-text">Just answer a few questions<br/> Get premium cv.</p>
            <div class="card">
                <form className="form-card" onSubmit={handleSubmit}>
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Project link<span class="text-danger"> *</span></label> <input type="url"  name="projectlink" placeholder="Enter your project link" value={formData.projectlink} onChange={handleInputChange} required/> </div>
