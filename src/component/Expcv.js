        ...
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
            ...
            <div class="card">
                <form className="form-card" onSubmit={handleSubmit}>
                    ...
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Linkedin<span class="text-danger"> </span></label> <input type="url"  name="linkedin" placeholder="Enter your linkedin link if any" value={formData.linkedin} onChange={handleInputChange} required/> </div>
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Portfolio<span class="text-danger"> </span></label> <input type="url"  name="portfolio" placeholder="Enter your portfolio link if any" value={formData.portfolio} onChange={handleInputChange} required/> </div>
                    </div>
                    ...
                    <div class="row justify-content-end">
                    <div class="form-group col-sm-12 flex-column d-flex"> <label class="form-control-label px-3">Professional experience<span class="text-danger"> *</span></label> <textarea type="text"  name="exp" placeholder="Professional experience" value={formData.exp} onChange={handleInputChange} required/> </div>
                    </div>
